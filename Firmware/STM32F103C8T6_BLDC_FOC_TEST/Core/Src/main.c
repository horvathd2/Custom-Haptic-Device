...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	...
	while (1)
	{
		__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, 220);
		__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, 880);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : BLDC_EN_Pin */
  GPIO_InitStruct.Pin = BLDC_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BLDC_EN_GPIO_Port, &GPIO_InitStruct);
